...
import com.harproj.harottapp.adepter.LiquidPageradepter;
import com.harproj.harottapp.utils.AppOpenAdManagerActivity;
        ...
        StringRequest sr = new StringRequest(Request.Method.GET, AppConfig.url +"get_config", response -> {
            ...
            try {
                ...
                if(HelperUtils.isFirstOpen(context)) {
                    tinyDB.putBoolean(Constants.AUTOPLAY, true);
                    tinyDB.putBoolean(Constants.EXTENTIONS, true);
                    tinyDB.putBoolean(Constants.SOFTWARE_EXTENTIONS, true);
