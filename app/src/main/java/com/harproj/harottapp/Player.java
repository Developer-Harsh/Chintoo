...
import com.harproj.harottapp.dialog.TrackSelectionDialog;
import com.harproj.harottapp.list.YTStreamList;
import com.harproj.harottapp.utils.HelperUtils;
import com.harproj.harottapp.utils.MediaHelper;
import com.harproj.harottapp.utils.TinyDB;
import com.harproj.harottapp.utils.Yts;
...
public class Player extends AppCompatActivity {
    ...
    void initializePlayer(MediaSource mediaSource) {
        ...
        renderersFactory = MediaHelper.buildRenderersFactory(this,sharedPreferences.getBoolean(Constants.EXTENTIONS,false)
                ,sharedPreferences.getBoolean(Constants.SOFTWARE_EXTENTIONS, false));
                           ...
                           for (JsonElement rootElement : jsonArray) {
                               ...
                               if(count == jsonArray.size()) {
                                   if(nMediaSource != null) {
                                       ...
                                       simpleExoPlayer.setPlayWhenReady(tinyDB.getBoolean(Constants.AUTOPLAY));
